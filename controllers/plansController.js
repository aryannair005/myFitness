...
module.exports.getWorkoutByCategories= async (req, res) => {
  try {
...
module.exports.planDetails=async (req, res) => {
  try {
...
module.exports.exerciseDetail= async (req, res) => {
  try {
...
module.exports.getPlanWorkout=async (req, res) => {
  try {
    const workoutPlan = await WorkoutPlan.findById(req.params.id)
      .populate('exercises.exerciseId');
...
module.exports.browseExercises=async (req, res) => {
  try {
