...
module.exports.getFoodDairy=async (req, res) => {
  try {
...
module.exports.getFoodDairyForSpecificDate=async (req, res) => {
  try {
...
module.exports.searchFoodWithApi=async (req, res) => {
  try {
    const { q } = req.query;
    if (!q || q.length < 2) {
...
module.exports.getFoodDetails= async (req, res) => {
  try {
...
module.exports.addFoodEntry= async (req, res) => {
  try {
    const {meal,date,foodId,foodName,servingId,servingDescription,numberOfServings,calories,carbs,protein,fat,fiber,sugar,sodium}= req.body;
...
module.exports.deleteFoodEntry=async (req, res) => {
  try {
...
module.exports.weeklySummary=async (req, res) => {
  try {
    const today = new Date();
